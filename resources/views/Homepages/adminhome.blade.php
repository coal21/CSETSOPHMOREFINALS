...
<div>
    ...
    <div id="id02" class="modal">
        ...
        <iframe src="{{ url('/approvals') }}" width="100%" height="50%"></iframe>
        </div>
    </div>
...
<div id="id03" class="modal">
    <div class="modal-content">
        ...
        <iframe src="{{ view('Homwefind.patientsearch') }}" width="100%" height="50%"></iframe>
    </div>
    </div>
...
<button class="btn5" onclick="document.getElementById('id05').style.display='block'">Rosters</button>
    <div id="id05" class="modal">
        <div class="modal-content">
            ...
            <iframe src="{{ view('Homwefind.roster') }}" width="100%" height="50%"></iframe>
        </div>
    </div>
